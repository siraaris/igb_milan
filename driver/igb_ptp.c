...
static bool disable_tx_latency_adjust;
module_param(disable_tx_latency_adjust, bool, 0644);
MODULE_PARM_DESC(disable_tx_latency_adjust,
		 "Disable i210/i211 TX timestamp latency compensation");

static bool disable_rx_latency_adjust;
module_param(disable_rx_latency_adjust, bool, 0644);
MODULE_PARM_DESC(disable_rx_latency_adjust,
		 "Disable i210/i211 RX timestamp latency compensation");
